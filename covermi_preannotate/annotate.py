...
import requests, csv, json, subprocess, stat, tempfile, os, pdb
from itertools import izip
from cache import keyvalcache
from cStringIO import StringIO
from collections import defaultdict

from covermi.gr import load_targets, load_principal
...
def vepscript(variants, assembly=DEFAULT_ASSEMBLY, species=DEFAULT_SPECIES, transcript_source=DEFAULT_TRANSCRIPTS):
    ...
    command = ["perl", "/home/ed/ensembl-vep-90/vep", "--json", "--offline", "--everything", "--no_stats", "-o", "STDOUT", "-i", temp.name, \
...
#       "everything"
def vep(variants, what="routine", panel=None, targets="", principal="", transcript_source=None, assembly=None, species=None):
    ROUTINE = 0
    ONE_PER_GENE = 1
    ONE_PER_VARIANT = 2
    EVERYTHING = 3
